...
startNum = 2;
endNum = 7;
timeID = fopen('time_dynamic_15_HOG_LBP_LPQ.txt','w');
for times=1:10
    
    fld_feature = strcat('dynamic_15_HOG_LBP_LPQ\',num2str(times));
    mkdir(fld_feature);
...
%                     frameGray = rgb2gray(frameRGB);
                    ...
                    compute_Features = [compute_Hog compute_LBP compute_LPQ];
%                     imshow(frameGray );
